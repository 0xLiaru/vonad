...
export const blockIcons = {
  'wallet-connect': Wallet, 'wallet-sign': FileCode, 'wallet-balance': TrendingUp, 'wallet-transfer': Send, 'wallet-disconnect': Key,
  'token-approve': CheckCircle, 'token-allowance': Search, 'token-transfer-alt': Send, 'token-burn': Flame,
